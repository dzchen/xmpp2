...
type
  ...
  public
    ...
    procedure RemoveTag(node: TXMLTag);overload;
    procedure RemoveTag(tag:string);overload;
    ...
    function  GetNamespace(children: boolean): String;overload;
    function  GetNamespace(): string;overload;
...
procedure TXMLTag.SetNameSpace(value: string);
begin
...
procedure TXMLTag.RemoveTag(tag: string);
begin
  RemoveTag(GetFirstTag('tag'));
end;
...
function TXMLTag.GetNamespace: string;
begin
  result:=GetNamespace(False);
end;

function TXMLTag.HasTagArray(arr: array of string): string;
var
  i:integer;
begin
...
function TXMLTag.GetNamespace(children: boolean): string;
var
  n:  TXMLNode;
  i:  integer;
begin
